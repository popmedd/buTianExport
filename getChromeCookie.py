...
def getCookiesFromChrome(domain):
    sql = f'SELECT name, encrypted_value '
    sql += f'as value FROM cookies where host_key like "%{domain}%"'
...
if __name__ == "__main__":
    domain = "butian.net"   # 目标网站域名
    cookie = getCookiesFromChrome(domain)
    print(cookie)